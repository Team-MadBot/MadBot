...
class HelpCommand(commands.Cog):
    ...
    @app_commands.command(
        name="help", description="[Полезности] Показывает основную информацию о боте."
    )
    ...
    async def help(self, interaction: discord.Interaction):
        ...
        for command in commands:
            ...
            if command.description.startswith(
                "[Развлечения]"
            ) or command.description.startswith("[NSFW]"):
            ...
            def __init__(self):
                options = [
                    ...
                    discord.SelectOption(
                        label="Статистика",
                        value="stats",
                        description="Настройка статистики сервера.",
                        emoji="📊",
                    ),
                    discord.SelectOption(
                        label="Свадьбы",
                        value="marry",
                        description="Женитесь и разводитесь.",
                        emoji="❤️",
                    ),
                    discord.SelectOption(
                        label="Премиум",
                        value="premium",
                        description="Управление премиум-подпиской.",
                        emoji="👑",
                    ),
                ]
        ...
        class DropDownHelp(discord.ui.Select):
            def __init__(self):
                options = [
                    ...
                    discord.SelectOption(
                        label="У меня вопрос!",
                        value="question",
                        description="Заполните форму, и вам ответят на вопрос!",
                        emoji="❓",
                    ),
                ]
            ...
            class BugReport(discord.ui.Modal, title="Сообщить о баге"):
                main = discord.ui.TextInput(
                    label="Тема:",
                    placeholder="Команда /команда выдаёт ошибку.",
                    max_length=50,
                )
                ...
                links = discord.ui.TextInput(
                    label="Ссылки на док-ва:",
                    required=False,
                    style=discord.TextStyle.paragraph,
                    max_length=1024,
                    placeholder="https://imgur.com/RiCkROLl",
                )
                ...
                async def on_submit(self, viewinteract: discord.Interaction):
                    ...
                    embed = discord.Embed(
                        title=f"Сообщение о баге: {str(self.main)}",
                        color=discord.Color.red(),
                        description=str(self.description),
                    )
                    embed.set_author(
                        name=str(viewinteract.user),
                    ...
                    embed = discord.Embed(
                        ...
                        description="Сообщение о баге успешно отправлено!",
                    )
            ...
            class AskQuestion(discord.ui.Modal, title="Задать вопрос"):
                main = discord.ui.TextInput(
                    label="Тема:", placeholder="Как сделать так-то.", max_length=50
                )
                description = discord.ui.TextInput(
                    label="Подробности:",
                    placeholder="Я хочу сделать так. Как так сделать?",
                    style=discord.TextStyle.paragraph,
                    max_length=2048,
                )
                links = discord.ui.TextInput(
                    ...
                    class Buttons(discord.ui.View):
                        ...
                        async def answer(
                            ...
                            class AnswerQuestion(
                                discord.ui.Modal, title="Ответ на вопрос"
                            ):
                                def __init__(self, main: str):
                                ...
                                async def on_submit(
                                    ...
                                    nonlocal q_embed
                                    embed = discord.Embed(
                                        title=f'Ответ на вопрос "{self.main}"!',
                                        color=discord.Color.green(),
                                    ...
                                    q_embed.add_field(
                                        name=f"Ответ от {ansinteract.user}:",
